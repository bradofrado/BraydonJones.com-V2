...
const getAboutItem = (): AboutItem => {
    return {
        descriptions: ['In 2014 when I was in middle school, I read my first book on programming and instantly fell in love. Since then, I\'ve worked on various projects ranging from Unity 3D games to websites made completely from scratch.', 
